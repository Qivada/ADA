...
__SILVER_TABLE_DELETE_FILTER_COLUMNS = ""
...
if __SILVER_TABLE_DELETE_FILTER_COLUMNS != '':
    __SILVER_TABLE_DELETE_FILTER_COLUMNS = __SILVER_TABLE_DELETE_FILTER_COLUMNS.replace('[', '').replace(']', '')
    __SILVER_TABLE_DELETE_FILTER_COLUMNS = ["`" + x.strip() + "`" for x in __SILVER_TABLE_DELETE_FILTER_COLUMNS.split(',')]
    print("Delete filter columns: " + ", ".join(__SILVER_TABLE_DELETE_FILTER_COLUMNS))
else:
    __SILVER_TABLE_DELETE_FILTER_COLUMNS = None
